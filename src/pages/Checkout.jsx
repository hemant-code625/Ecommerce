...
function Checkout() {
  ...
  const totalAmount = products.reduce(
    (amount, product) => amount + discountedPrice(product) * product.quantity,
    0
  );
  ...
  const handleChange = (e, product) => {
    dispatch(
      updateCartItemAsync({ ...product, quantity: parseInt(e.target.value) })
    );
  };
          ...
          <form
            ...
            onSubmit={handleSubmit((data) => {
              ...
              dispatch(
                ...
                .then(() => {
                  reset();
                  // Optionally, you might want to show a success message or redirect the user
                })
                .catch((error) => {
